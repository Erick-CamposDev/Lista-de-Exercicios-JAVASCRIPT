...
const students = [
  ...
  { nome: "Rodrigo", notaTotal: 32, curso: "Ciência da Computação", status: "Em andamento" },
  { nome: "Daniel", notaTotal: 79, cursor: "Engenharia", status: "Concluído" },
  { nome: "Leandro", notaTotal: 45, curso: "Arquitetura", status: "Trancou o curso" },
  { nome: "Mariana", notaTotal: 88, curso: "Psicologia", status: "Concluído" },
  { nome: "Fernanda", notaTotal: 60, curso: "Administração",status: "Trancou o curso" },
